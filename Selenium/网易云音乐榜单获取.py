...
with open('网易云热歌.csv', "w", encoding='utf-8', newline='') as f:
    ...
    for i in range(1, 5):
        ...
        time.sleep(1)
        lst = driver.find_elements(By.XPATH, '//*[@class="j-flag"]/table/tbody/tr')
        for song in lst:
            song_name = song.find_element(By.XPATH, './/div[@class="ttc"]//b').get_attribute('title')
            singer_name = song.find_element(By.XPATH, './td/div[@class="text"]/span').get_attribute('title')
